...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String dateText = ForecastDateUtils.getFriendlyDateString(this, localDateMidnightGmt, true);

        mDateView.setText(dateText);

        int weatherId = data.getInt(INDEX_WEATHER_CONDITION_ID);
        String description = ForecastWeatherUtils.getStringForWeatherCondition(this, weatherId);

        mDescriptionView.setText(description);
        double highInCelsius = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highString = ForecastWeatherUtils.formatTemperature(this, highInCelsius);

        mHighTemperatureView.setText(highString);
        double lowInCelsius = data.getDouble(INDEX_WEATHER_MIN_TEMP);

        String lowString = ForecastWeatherUtils.formatTemperature(this, lowInCelsius);
        ...
        String windString = ForecastWeatherUtils.getFormattedWind(this, windSpeed, windDirection);
